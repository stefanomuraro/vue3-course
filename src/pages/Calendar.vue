  ...
  <div class="w-full flex flex-col items-center">
    <div class="m-auto mb-7">
      ...
      <section class="my-4 flex justify-between">
        <button class="px-2 border rounded" v-on:click="goToPrev()">
          Previous
        </button>
        <button class="px-2 border rounded" v-on:click="goToNext()">
          Next
        </button>
      </section>
    </div>
    <a target="_blank" href="https://next.router.vuejs.org/"
      >&gt;&gt; Vue Router Docs &lt;&lt;</a
    >
  </div>
</template>
