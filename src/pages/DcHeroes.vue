<template>
    <div id="container">
        ...
        <div class="m-5">
            ...
            <p>{{randM()}}</p>
            <ul>
                <li>Not cached. It runs every time it is called (all three numbers are not equal).</li>
                <li>It runs when update occurs (every time the component is re-rendered).</li>
            </ul>
            <a href="https://vuejs.org/v2/guide/computed.html#Computed-Caching-vs-Methods" target="_blank"><strong>&gt;&gt; More Info &lt;&lt;</strong></a>
        </div>
    </div>
</template>
